...
import com.bag2bag.st.services.EmailServices;
...
public class UserController {
     ...
     */
    @GetMapping("/code")
    public ResponseEntity<Map<String, Object>> sendCode(@RequestParam("upi") String upi) {
        ...
        return ResponseEntity.ok(body); // 一定有 JSON 回包
    }
